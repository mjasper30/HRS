    <div class="sidebar-menu">
        ...
        <div class="menu">
            <ul id="menu">
                ...
                <li id="menu-academico"><a href="#"><i class="fa fa-table"></i> <span> Room Category</span> <span
                            class="fa fa-angle-right" style="float: right"></span></a>
                    <ul id="menu-academico-sub">
                        <li id="menu-academico-avaliacoes"><a href="add-category.php">Add Category</a></li>
                        <li id="menu-academico-avaliacoes"><a href="manage-category.php">Manage Category</a></li>

                    </ul>
                </li>
                <li id="menu-academico"><a href="#"><i class="lnr lnr-layers"></i> <span>Facility</span> <span
                            class="fa fa-angle-right" style="float: right"></span></a>
                    <ul id="menu-academico-sub">
                ...
                <li id="menu-academico"><a href="#"><i class="lnr lnr-book"></i> <span>Reservation</span> <span
                            class="fa fa-angle-right" style="float: right"></span></a>
                    <ul id="menu-academico-sub">
                        <li id="menu-academico-avaliacoes"><a href="all-booking.php">All Reservation</a></li>
                ...
                <!--<li><a href="walkin.php"><i class="glyphicon glyphicon-check"></i> <span>Walk-in</span></a></li>-->
