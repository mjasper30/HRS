  ...
  header('location:logout.php');
    ...
    if(isset($_POST['submit'])){
        ...
        if(!in_array($extension,$allowed_extensions)){
            ...
            $sql="insert into hrs_tblfacility(FacilityTitle,Description,Image)values('$ftitle','$facdes','$img')";
                                ...
                                <div class="forms">
                                    <div class="form-grids widget-shadow" data-example-id="basic-forms">
                                        <div class="form-title">
                                            <center><h4 style="padding: 15px;">Add Facility</h4></center>
                                        </div>
                                        <div class="form-body">
                                            ...
                                            <form method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group"> <label for="exampleInputEmail1">Facility
                                                        ...
                                                        name="ftitle" value="" required='true'> </div>
                                                <div class="form-group"> <label
                                                        for="exampleInputEmail1">Description</label> <textarea
                                                        type="text" class="form-control" name="facdes"
                                                        value=""></textarea> </div>
