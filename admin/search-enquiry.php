...
<head>
    <title>Rastatel | Search Enquiry</title>
                                    ...
                                    <div class="form-grids widget-shadow" data-example-id="basic-forms">
                                        ...
                                        <form id="basic-form" method="post">
                                            <div class="form-group" style="padding-top: 20px">
                                                <label style="font-size: 20px;padding-bottom: 10px">Search
                                                    Enquiry</label>
                                                <input style="width: 250px;" id="searchdata" type="text" name="searchdata" required="true"
                                        ...
                                        <div class="form-body">
                                            ...
                                            <table
                                                ...
                                                <tbody>
                                                    ...
                                                    $ret = "SELECT ID FROM hrs_tblcontact";
                                                    $result = mysqli_query($conn, $ret);
                                                    mysqli_fetch_all($result, MYSQLI_ASSOC);
                                                    $total_rows=$result->num_rows;
                                                    $total_pages = ceil($total_rows / $no_of_records_per_page);

                                                    $sql="SELECT * from hrs_tblcontact where MobileNumber like '$sdata%' LIMIT $offset, $no_of_records_per_page";
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="font-w600"><?php  echo $row['Name'];?>
                                                        </td>
                                                        ...
                                                        <td class="d-none d-sm-table-cell">
                                                            <span
                                                                class="badge badge-primary"><?php  echo $row['EnquiryDate'];?></span>
                                                        </td>
                                                        <td><a href="view-enquiry.php?viewid=<?php echo $row['ID'];?>">View
                                                                Details</a></td>
                                                    </tr>
                                                </tbody>
