...
if (strlen($_SESSION['hbmsaid']==0)) {
    ...
    if(isset($_POST['submit'])){
        ...
        $sql="update hrs_tblpage set PageTitle='$pagetitle',PageDescription='$pagedes' where PageType='aboutus'";
                                ...
                                <div class="forms">
                                    <div class="form-grids widget-shadow" data-example-id="basic-forms">
                                        <div class="form-title">
                                            <center><h4 style="padding: 15px;">About Us</h4></center>
                                        </div>
                                        <div class="form-body">
                                            ...
                                            <form method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group"> <label for="exampleInputEmail1">Page
                                                        ...
                                                        id="pagedes" required="true" rows="10" cols="50"
