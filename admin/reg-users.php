                                ...
                                <div class="forms">
                                    <div class="form-grids widget-shadow" data-example-id="basic-forms">
                                        <div class="form-title">
                                            <center><h4 style="padding: 15px;">Register Users</h4></center>
                                        </div>
                                        <div class="form-group" style="padding-top: 20px">
                                            <a style="color: white;" href="add-user.php"><span><button class="btn btn-primary">Add User
                                                        </button< /span></a>
                                        </div>
                                        <div class="form-body">
                                            ...
                                            <table
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="d-none d-sm-table-cell">Register Date <br>
                                                            (yyyy/mm/dd)</th>
