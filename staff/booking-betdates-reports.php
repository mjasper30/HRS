                                        ...
                                        <div class="form-body">
                                            ...
                                            <form method="post" action="booking-bwdates-reports-details.php">
                                                <div class="form-group"> <label for="exampleInputEmail1">From
                                                        Date:</label> <input style="width: 250px;" type="date" class="form-control"
                                                        id="fromdate" name="fromdate" value="" required='true'> </div>

                                                <div class="form-group"> <label for="exampleInputEmail1">To
                                                        Date:</label> <input style="width: 250px;" type="date" class="form-control"
                                                        id="todate" name="todate" value="" required='true'> </div>
