...
if (strlen($_SESSION['hbmssid']==0)) {
  header('location:logout.php');
      ...
      if(isset($_GET['delid'])){
        ...
        $sql="delete from hrs_tblroom where ID='$rid'";
...
<head>
    <title>Rastatel | Manage Room</title>
                                            ...
                                            <table
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="d-none d-sm-table-cell">Room Status</th>
                                                        <th class="d-none d-sm-table-cell">Room Quantity</th>
                                                        <th class="d-none d-sm-table-cell">Price</th>
                                                        <th class="d-none d-sm-table-cell">Creation Date<br>(yyyy-mm-dd | time)</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    $ret = "SELECT ID FROM hrs_tblroom";
                                                    $result = mysqli_query($conn, $ret);
                                                    mysqli_fetch_all($result, MYSQLI_ASSOC);
                                                    $total_rows=$result->num_rows;
                                                    $total_pages = ceil($total_rows / $no_of_records_per_page);
                                                    
                                                    $sql="SELECT * from hrs_tblroom LIMIT $offset, $no_of_records_per_page";
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="d-none d-sm-table-cell">
                                                            <?php  echo $row['RoomDesc'];?></td>
                                                        <td class="d-none d-sm-table-cell"><img
                                                                src="images/<?php echo $row['Image'];?>" width="100"
                                                                height="100"></td>
                                                        <td class="d-none d-sm-table-cell">
                                                            <?php  
                                                            if($row['RoomQuantity'] > 0 && $row['Availability'] == "Available"){
                                                                ?><p style="background-color: green; color: white; border-radius: 5px; padding: 5px;"><?php echo $row['Availability'];?></p><?php
                                                            }else if($row['RoomQuantity'] <= 0 || $row['Availability'] == "Not Available"){
                                                                $row['Availability'] = "Not Available";
                                                                ?><p style="background-color: red; color: white; border-radius: 5px; padding: 5px;"><?php echo $row['Availability'];?></p><?php
                                                            }else if($row['Availability'] == "Maintenance"){
                                                                $row['Availability'] = "Maintenance";
                                                                ?><p style="background-color: orange; color: white; border-radius: 5px; padding: 5px;"><?php echo $row['Availability'];?></p><?php
                                                            }
                                                            ?>
                                                        </td>
                                                        <td class="d-none d-sm-table-cell">
                                                            <?php  echo $row['RoomQuantity'];?>
                                                        </td>
                                                        ...
                                                        <td class="d-none d-sm-table-cell">
                                                            <span
                                                                class="badge badge-primary"><?php  echo $row['CreationDate'];?></span>
                                                        </td>

                                                        <td class="d-none d-sm-table-cell">
                                                            <button class="btn-edit">
                                                                <a href="edit-room.php?editid=<?php echo $row['ID'];?>"
                                                                    onclick="return">Edit</a>
                                                            </button>
                                                        
                                                            <!--<button class="btn-delete">-->
                                                            <!--    <a href="manage-room.php?delid=<?php echo $row['ID'];?>"-->
