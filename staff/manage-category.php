                                        ...
                                        <div class="form-body">
                                            ...
                                            <table
                                                ...
                                                <tbody>
                                                    ...
                                                    $ret = "SELECT ID FROM hrs_tblcategory";
                                                    ...
                                                    $sql="SELECT * from hrs_tblcategory LIMIT $offset,$no_of_records_per_page";
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="d-none d-sm-table-cell">
                                                            <span
                                                                class="badge badge-primary"><?php  echo $row['Date'];?></span>
                                                        </td>
                                                        <td class="d-none d-sm-table-cell">
                                                            <button class="btn-edit">
                                                            <a
                                                                href="edit-category.php?editid=<?php echo $row['ID'];?>"
