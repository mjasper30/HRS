                ...
                <div class="content">
                    <div class="women_main">
                            <div class="form-group" style="padding-top: 20px">
                                <a style="color: white;" href="add-user.php"><span><button class="btn btn-primary">Add User</button</span></a>
                            </div>
                        <!-- start content -->
                        <div class="grids">
                                            ...
                                            <table
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="d-none d-sm-table-cell">Register Date <br> (yyyy/mm/dd)</th>
                                                ...
                                                $ret = "SELECT ID FROM hrs_tbluser";
                                                $result = mysqli_query($conn, $ret);
                                                mysqli_fetch_all($result, MYSQLI_ASSOC);
                                                $total_rows=$result->num_rows;
                                                $total_pages = ceil($total_rows / $no_of_records_per_page);

                                                $sql="SELECT * from hrs_tbluser LIMIT $offset, $no_of_records_per_page";
                                                if($rs=$conn->query($sql)){
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="d-none d-sm-table-cell">
                                                            <span
                                                                class="badge badge-primary"><?php  echo $row['RegDate'];?></span>
                                                        </td>
