...
<head>
    <title>Rastatel | Cancelled Booking</title>
                        ...
                        <div class="grids">
                            ...
                            <div class="panel panel-widget forms-panel">
                                <div class="forms">
                                    ...
                                    $sql="SELECT hrs_tbluser.*,hrs_tblbooking.BookingNumber,hrs_tblbooking.Status,hrs_tblbooking.BookingDate from hrs_tblbooking join hrs_tbluser on hrs_tblbooking.UserID=hrs_tbluser.ID where hrs_tblbooking.Status='Cancelled' LIMIT $offset, $no_of_records_per_page";
