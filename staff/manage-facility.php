                        ...
                        <div class="grids">
                            ...
                            <div class="panel panel-widget forms-panel">
                                <div class="forms">
                                    ...
                                    $ret = "SELECT ID FROM hrs_tblfacility";
                                    ...
                                    $sql="SELECT * from hrs_tblfacility LIMIT $offset, $no_of_records_per_page";
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="d-none d-sm-table-cell">
                                                                ...
                                                                <button class="btn-edit">
                                                                    <a
                                                                    href="edit-facility.php?editid=<?php echo $row['ID'];?>"
                                                                    onclick="return">Edit</a>
                                                                </button>
                                                                
                                                                <!--<button class="btn-delete">-->
                                                                <!--    <a href="manage-facility.php?delid=<?php echo $row['ID'];?>"-->
