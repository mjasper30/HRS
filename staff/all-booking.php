...
<head>
    <title>Rastatel | All Booking</title>
                        ...
                        <div class="grids">
                            ...
                            <form id="basic-form" method="post">
                                <div class="form-group" style="padding-top: 20px">
                                        <input style="width: 250px; display: inline;" id="searchdata" type="text" name="searchdata" required="true" class="form-control" placeholder="Search Booking Number">
