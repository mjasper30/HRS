...
<head>
    <title>Rastatel | Between Dates Enquiry Report</title>
                                        ...
                                        <div class="form-body">
                                            ...
                                            <table
                                                ...
                                                <tbody>
                                                    ...
                                                    $sql="SELECT * from hrs_tblcontact where date(EnquiryDate) between '$fdate' and '$tdate' LIMIT $offset, $no_of_records_per_page";
